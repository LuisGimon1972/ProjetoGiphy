            ...
            <div class="conteudo"> <br/>            
                  <div v-if="mostrarBusca">
                    ...
                    <div class="galeria-gifs">
                      <div v-for="gif in gifs" :key="gif.id"  class="gif-container">
                        <q-img :src="gif.images.fixed_height.url" :alt="gif.title" fit="cover" class="gif-imagem" >      
                ...
                <div v-else-if="titulo === 'Sobre'" class="justificar">
                      ...
                      <p class="sobre alinhar">
                          ...
                          <strong>Luis Manuel Gimón Silva</strong>, da <strong>SGBR Sistemas</strong>, criada para quem
                          deseja explorar GIFs animados de forma rápida, organizada e intuitiva. A plataforma utiliza a
                          API oficial do <strong>GIPHY</strong>, permitindo buscas eficientes, acesso aos GIFs em alta e a
                          possibilidade de salvar conteúdos favoritos para consultas futuras.
                      </p>
                      <p class="sobre alinhar">
                            Desenvolvido com <strong>Vue 3</strong> e <strong>Quasar Framework 2</strong>, o sistema oferece
                        uma navegação fluida, layout moderno e excelente experiência do usuário. A aplicação adota uma
                        arquitetura organizada, utilizando o <strong>Vue Router</strong> para navegação entre módulos e
                        <strong>TypeScript</strong> para garantir maior segurança, legibilidade e manutenção do código.
                      </p>

                      <p class="sobre alinhar">
                        As funcionalidades de configuração permitem ao usuário personalizar a experiência, incluindo
                        a alternância entre <strong>modo claro e modo escuro</strong>, com persistência automática das
                        preferências por meio do <strong>LocalStorage</strong>. O sistema também oferece opções para
                        gerenciamento de dados locais, como limpeza do histórico de buscas e dos GIFs favoritos,
                        proporcionando maior controle e praticidade.
                      </p>

                      <p class="sobre alinhar">
                        As requisições à API são realizadas com <strong>Axios</strong>, garantindo comunicação eficiente
                        e confiável. Os dados do usuário, como favoritos, histórico de pesquisas e preferências de tema,
                        permanecem salvos no navegador, assegurando continuidade da experiência mesmo após o
                        encerramento da aplicação.
                      </p>

                      <p class="sobre alinhar">
                        Mais do que um simples projeto, o <strong>Master Giphy Sistemas</strong> representa a aplicação
                        prática de boas práticas de desenvolvimento frontend, unindo aprendizado, organização,
                        desempenho e uma interface agradável em um sistema funcional e evolutivo.
                      </p>
